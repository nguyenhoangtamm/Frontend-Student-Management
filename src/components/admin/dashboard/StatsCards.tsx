  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 p-6 bg-gray-100">
      {stats.map((stat, index) => (
        <div key={index} className="bg-white p-6 rounded-xl shadow-md flex flex-col gap-3">
          <div className={`w-12 h-12 flex items-center justify-center rounded-full ${stat.bgColor}`}>
            {stat.icon}
          </div>
